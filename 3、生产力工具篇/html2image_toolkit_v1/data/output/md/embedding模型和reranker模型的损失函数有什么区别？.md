...
![用户头像](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\bed7131d4845ed3237e0eb6c59db41b5.jpg) Just do it！ 
...
总结下embedding模型和reranker模型的损失函数 
  ...
  1. 引言 
  2. 一、embedding模型 
  3. 1.1 embedding模型的目标是什么？ 
  4. 1.2 embedding模型常用的损失函数有哪些？ 
  5. 1.2.1 对比损失（Contrastive Loss） 
  6. 1.2.2 三元组损失（Triplet Loss） 
  7. 1.2.3 InfoNCE Loss（基于 Softmax 的对比学习损失） 
  8. 1.2.4 Multiple Negatives Ranking Loss（多负例排序损失） 
  9. 1.3 embedding模型常用的损失函数如何选型？ 
  10. 二、Rerank模型 
  11. 2.1 Rerank 模型的目标是什么？ 
  12. 2.2 Rerank 模型常用的损失函数有哪些？ 
  13. 2.2.1 Cross-Entropy Loss（交叉熵损失） 
  14. 2.2.2 Pairwise Ranking Loss（成对排序损失） 
  15. 2.2.3 Listwise Loss（列表排序损失，如 LambdaLoss） 
  16. 2.3 embedding模型常用的损失函数如何选型？ 
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\dd6aede102a627e57fc14e4991a6fb37.jpg)
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\f66a66f63b4b031b31b746644d3b4729.jpg)
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\94c9c3f7003b1fe97b5e5ad8b6750139.jpg)
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\b00e0a963b5b81434efcef5e21f34809.jpg)
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\262224e08bdb550b202bd37a6eafbe08.jpg)
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\8b026c8a3457ab894e08d4fa0af6848d.jpg)
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\b5d03bddbf0556395621280c3a8d518f.jpg)
...
![](D:\LM-Is-All-You-Need\3、生产力工具篇\html2image_toolkit copy\data\output\images\b45d264fb674694861c2cdcd081bd636.png)
